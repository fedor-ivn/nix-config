{
  ...
  outputs = inputs@{ self, nix-darwin, nixpkgs, nixpkgs-stable, home-manager, nix-homebrew, homebrew-bundle, homebrew-core, homebrew-cask }:
  let
  ...
  in
  {
    ...
    darwinConfigurations.${hostname} = nix-darwin.lib.darwinSystem {
      ...
      specialArgs = { inherit inputs self system username pkgs-stable hostname; };
      modules = [ 
        ./system/default.nix
