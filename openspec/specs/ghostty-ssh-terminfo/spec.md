...
Ensure seamless SSH sessions from the Ghostty terminal by propagating terminfo to remote hosts automatically (via shell integration) and pre-installing it on all managed NixOS hosts.
